                                    ...
                                    @foreach($myCampaigns as $campaign)
                                        <tr class='clickable-row' data-target="#campaignEditModal-{{ $campaign->id }}" data-toggle="modal">
                                            ...
                                            @if($campaign->status == 'complete')
                                                <td><a id="{{ $campaign->id }}" class="close delete-campaign-button pull-right">&times;</a><span class="badge badge-success badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>Complete</span></span></td>
                                            @else
